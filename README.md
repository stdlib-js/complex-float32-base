...
```javascript
import { add, assert, identity, mul, neg, scale, sub } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base@v0.2.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base@v0.2.1-esm/index.mjs';
