...
```javascript
import { add, add3, assert, div, identity, mul, muladd, neg, scale, sub } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base@deno/mod.js';
```
...
[@stdlib/complex/float32/base/add3]: https://github.com/stdlib-js/complex-float32-base-add3/tree/deno

[@stdlib/complex/float32/base/div]: https://github.com/stdlib-js/complex-float32-base-div/tree/deno

[@stdlib/complex/float32/base/identity]: https://github.com/stdlib-js/complex-float32-base-identity/tree/deno

[@stdlib/complex/float32/base/mul-add]: https://github.com/stdlib-js/complex-float32-base-mul-add/tree/deno
